 ...
 ******************************************************************************/
package cn.hiproject.pm.server.sql;
...
public interface SQLs {
  ...
  String ACCOUNT_CREATE_TABLE = ""
	      ...
	      + "         (account_id VARCHAR(64) NOT NULL CONSTRAINT ORGANIZATION_PK PRIMARY KEY,"
	      + "          account_name VARCHAR(64), "
	      + "          account_full_name VARCHAR(512), "
	      + "          status VARCHAR(64), "
	      + "          password VARCHAR(64), "
	      + "          country VARCHAR(2), "
	      + "          phone VARCHAR(20), "
...
// end::createDB[]
  ...
  String ACCOUNT_PAGE_DATA_SELECT_INTO = ""
      + "INTO     :{page.accountId}, " // <1>
      + "         :{page.accountName}, "
      + "         :{page.accountFullName}, "
      + "         :{page.email}, "
      + "         :{page.phone}, "
      + "         :{page.password}, "
      + "         :{page.status}, "
  ...
  String ACCOUNT_VALUES_02 = ""
	      + "VALUES  ('0002', "
	      + "         'admin2', "
	      + "         'Administrator 02', "
	      + "         'ahuang@midtronics.com', "
	      + "         '1581887888', "
	      + "         'password', "
	      + "         'Active', "
	      + "         'CN')";
